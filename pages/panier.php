...
<html lang="en">
  ...
  <body>
   ...
   <div class="container">
      ...
      ?>
      <div class="form-group">
        <label class="col-md-4 control-label" for="textinput">Produits</label>  
          <div class="col-md-4">

         <input id='textinput' name='login' type='text' value='' class='form-control input-md'><a href='?del=<?= $product->id; ?>'><img width='15' height='15' src='images/del.png'/></a>
